...
![](/images/feishu/assets/2025-11-10-Docker-005.png)
...
![](/images/feishu/assets/2025-11-10-Docker-006.png)

### 3.2.NVIDIA显卡直通

NVIDIA Container Toolkit使用户 **能够构建和运行GPU加速的容器** 。该工具包包括一个容器运行库和实用程序，用于自动配置容器以利用NVIDIA GPU。

![](/images/feishu/assets/2025-11-10-Docker-007.png)
...
![](/images/feishu/assets/2025-11-10-Docker-008.png)
...
![](/images/feishu/assets/2025-11-10-Docker-009.png)
